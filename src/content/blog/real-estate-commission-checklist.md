---
title: "Real Estate Commission Checklist: 2026 Guide"
slug: "real-estate-commission-checklist"
pubDate: 2026-05-06
description: "Step-by-step real estate commission checklist for 2026. Track rates, splits, fees & payouts to keep every dollar earned on every deal."
author: "Vladislav T."
...
[→ Related: Listing Agreement Explained](/listing-agreement-explained)
...
- **50/50 split** — typical for new agents in their first year or two
- **70/30 split** — common mid-career arrangement
- **80/20 split** — for experienced, high-producing agents
- **100% commission with desk fees** — you keep everything but pay a monthly fee (often $500–$1,500/month plus per-transaction fees, as of 2025)
...
[→ Related: Real Estate Broker Split Models](/real-estate-broker-split-models)
...
| Deduction | Typical Range (as of 2025) |
|---|---|
...
| Referral Fees | 20–35% of your GCI |
...
[→ Related: Real Estate Agent Business Expenses](/real-estate-agent-business-expenses)
...
- The exact dollar amount matches your Listing Agreement or Buyer Representation Agreement
- Buyer-agent compensation is disclosed separately (required under post-2024 NAR rules)
- No last-minute changes were made by the title company or escrow officer without your consent
...
[→ Related: How to Read a Closing Disclosure](/how-to-read-closing-disclosure)
...
[→ Related: Commission Disbursement Authorization Template](/commission-disbursement-authorization-template)
...
[→ Related: Real Estate Agent Tax Deductions](/real-estate-agent-tax-deductions)
...
- **Written Buyer Representation Agreements are required** before you show a single property. No agreement, no representation, no commission. (Source: National Association of Realtors, 2025)
- **Buyer-agent compensation is no longer offered through the MLS.** Sellers can still choose to pay the buyer's agent, but it must be negotiated directly — case by case, deal by deal.
- **The Department of Justice continues to monitor compliance.** Antitrust scrutiny hasn't gone away. Proper documentation is your best defense.
...
[→ Related: NAR Settlement Rules 2024 — What Changed](/nar-settlement-rules-2024) | [Buyer Representation Agreement Guide](/buyer-representation-agreement-guide)
...
| # | Item | Details / Notes |
|---|---|---|
| 1 | Property Address | ___________________ |
| 2 | Sale Price | $__________________ |
| 3 | Commission Rate (your side) | ______% or flat $______ |
| 4 | GCI (Sale Price × Rate) | $__________________ |
| 5 | Broker Split (% or $) | $__________________ |
| 6 | Franchise Fee (if applicable) | $__________________ |
| 7 | Deductions (TC, E&O, referral, MLS) | $__________________ |
| 8 | Net Commission | $__________________ |
| 9 | Closing Disclosure verified? | ☐ Yes ☐ No |
| 10 | CDA signed & on file? | ☐ Yes ☐ No |
| — | Payout Date Received | ____/____/________ |
